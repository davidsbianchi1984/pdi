...
DIRECTIONS: dict[str, tuple[str, ...]] = {
    ...
    "continuity": ("a bequest", "an heir", "if i die", "continuity",
                   "the gateway", "who is on shift"),
    "operations": ("the journal", "coordination", "a joint plan",
                   "operations", "what qrme sealed"),
    "positions": ("my role", "my position", "the questionnaire",
                  "assistant blueprint", "map my job"),
    "settings": ("settings", "backend url", "admin token",
                 "open on my phone", "pair my phone"),
    "access": ("accessibility", "a disability", "screen reader",
               "cannot use", "can't use", "report a barrier",
               "what stood in the way", "ability"),
