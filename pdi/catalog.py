...
Beyond the social platforms (``connectors.py``), a tenant's agents can connect
to the AI-integrated **apps** on a person's devices — the same surfaces Apple
Intelligence, Google Gemini, Microsoft Copilot and Canva expose. Data collected
through them is sealed in the vault like any other record.
Each entry declares:
