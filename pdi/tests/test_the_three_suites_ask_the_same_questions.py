...
by exactly two — and four of those were one defect, here — in the product
...
This product reports its version from `/health` under a differently-named
test, and this file would call that a gap if the record did not hold it as a
row.
