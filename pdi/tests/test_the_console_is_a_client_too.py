...
union backlog reads 58 while the console alone cannot reach **84**
...
with a snapshot of its own: **84 at the start, and it must not grow.**
...
def test_the_union_is_never_worse_than_the_console():
    ...
    up. Sound while catching up was hypothetical. It is not any more: both
    are zero, which is the outcome the whole audit was for rather than a
    fault in it.
