...
def test_the_scan_finds_the_bindings_at_all():
    ...
    and a false one about what it held — and this is the product it was
    calibrated for, where it still reads as a seventh of the 141 bindings
    here. It is registered per product now, measured against this product.
    """
    found = _bindings()
