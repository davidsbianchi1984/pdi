...
SHELLS = (
    ("ios", "native/ios/Sources/Problems.swift", "native/ios/Sources/PdiVaultApp.swift",
     "Problems.send("),
    ("android", "native/android/app/src/main/java/com/pdi/vault/Problems.kt", "native/android/app/src/main/java/com/pdi/vault/MainActivity.kt", "Problems.send("),
