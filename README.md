...
The full capability set is **also rendered in the desktop frame**: every one of the 43 mobile screens below has a wide operator-console counterpart in [`docs/screens/desktop/`](docs/screens/desktop) — window chrome, left nav rail, right status rail — generated by the same `docs/screens/build.py`.
