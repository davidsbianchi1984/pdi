...
| Release | What landed |
|---|---|
| **3.4.0** | **Version only** — nothing in the vault changed this round beyond the retired disclosure. QRME and JIM-mini 3.4.0 carry the attention networks that condition every reply on the degree of engagement and train offline on encrypted weights; this keeps the trio in step |
| **3.3.1** | **Version only** — nothing in the vault changed this round. QRME 3.3.1 puts a version check at the end of the deploy block and examines the occupation catalogue; this keeps the trio in step |
| **3.3.0** | **Version only** — nothing in the vault changed this round. The three products are deployed together and read each other's version; QRME 3.3.0 carries the occupation catalogue, and this keeps the trio in step |
