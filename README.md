...
The full illustrated tour — every screen, in order, with its prose —
lives in **[docs/gallery.md](docs/gallery.md)**. Kept here: the vault at
a glance.
...
<table>
  <tr>
    ...
    <td align="center" width="50%"><a href="docs/desktop/02-vault.svg"><img src="docs/desktop/02-vault.svg" width="460" alt="Vault"></a><br><sub><b>02</b> · Vault</sub></td>
  </tr>
</table>
